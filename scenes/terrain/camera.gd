...
#  var grass_test = $GrassTest
#  direction = (point_camera.get_global_transform().origin - camera.get_global_transform().origin).normalized()
#  print(direction)
#  process_material.set_shader_param('direction', direction)
